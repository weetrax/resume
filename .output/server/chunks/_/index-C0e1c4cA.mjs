...
import { c as createLucideIcon, B as Button, M as Mail, a as cn, b as Building2 } from "./router-MVA8ljkQ.mjs";
import { motion as motion$1 } from "framer-motion";
import { memo, useState, useRef } from "react";
import { useScroll, motion, useMotionValue, useSpring, useTransform, AnimatePresence } from "motion/react";
...
const projects = [
  ...
  },
  {
    ...
    description: "Outil CLI pour générer les fichiers types et requêtes GraphQL à partir d'un schéma existant.",
    imageUrl: "/gql.png",
...
function App() {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen px-8 py-36", children: [
    ...
    /* @__PURE__ */ jsxs("section", { id: "experiences", className: "text-center max-w-3xl mx-auto grid gap-4 scroll-mt-24", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative text-left", children: experiences.map((experience) => /* @__PURE__ */ jsx(Experience, { experience }, `exp_${experience.role}`)) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "flex justify-center h-20 my-12", children: /* @__PURE__ */ jsx(Separator, { orientation: "vertical" }) }),
